...
import io.vmchura.vevial.PlanarGeometric.ConfigParametersGeometric.{areCloseValuesForDirection, areCloseValuesForMagnitude, isMagnitudeValidForUnitaryVector, isValidMagnitudeForGeneralVector}
