...
import agent.{ActorCriticSoftmaxAgent, ActorCriticSoftmaxAgentBreeze, ActorCriticSoftmaxAgentLinear, AgentInfo}
...
class SoftMaxBreezeTest extends AnyFlatSpec {
  ...
  it should "work fine with glue and environment" in {
    ...
    val test_agent = () => new ActorCriticSoftmaxAgentBreeze
  ...
  it should "generate correct runs" in {
    ...
    SoftMax.run_experiment(() => new PendulumEnvironment,() => new ActorCriticSoftmaxAgentBreeze,envParamenters,agentParamenters,experimentParamenters)
  }
